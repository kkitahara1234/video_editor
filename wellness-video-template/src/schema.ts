...
export type CameraAngle = "front" | "left";
...
export type VideoStartTrimSec = { front: number; left: number };
...
export const DEMO_SCRIPT: ScriptData = {
  ...
  segments: [
    ...
    { id: "intro-02", angle: "left", startSec: 14, endSec: 20, topicLabel: "はじめに" },
    // ── 睡眠 ──────────────────────────── F F S F F S
    ...
    { id: "sleep-05", angle: "left", startSec: 58, endSec: 65, topicLabel: "睡眠" },
    // ── 食事と栄養 ────────────────────── F F S F F S
    ...
    { id: "nutrition-05", angle: "left", startSec: 103, endSec: 110, topicLabel: "食事と栄養" },
    // ── まとめ ────────────────────────── F F S
